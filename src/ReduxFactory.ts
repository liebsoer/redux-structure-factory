...
export class ReduxFactory {
    ...
    topContainer: ReduxStructureContainer;
     ...
     * @memberof ReduxFactory
     */
    createContainer(name: string, config: any, parent?: ReduxStructureContainer, override?: boolean) {
     ...
     * @memberof ReduxFactory
     */
    testConfig(name: string, config: any, parent?: ReduxStructureContainer, override?: boolean) {
        ...
        if (!override && parent && parent.slices && parent.slices[name]) {
